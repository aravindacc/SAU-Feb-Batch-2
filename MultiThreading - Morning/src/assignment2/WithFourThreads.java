...
class fourth_thread extends Thread{
    String str;
    int lengthofString;
    fourth_thread(String str){
        this.str = str;
        this.lengthofString = str.length();
    }
    public void run()
...
public class WithFourThreads {
    public static void main(String[] args) {
        long initialTime = System.currentTimeMillis();
        String str1 = "(NTS) road network, with paved roads leading south to Mercury and west to Yucca Flat. Leading northeast from the lake, the wide and well-maintained Groom "+
        ...
        String str2 = "Although official information is sparse, it is believed that the US military continues" +
                ...
                "including the small town of Rachel on the Extraterrestrial Highway. The original rectangular base of 6 by 10 miles (9.7 by 16.1 km) is now part of the so"+ "called Groom box," +
                "a rectangular area measuring 23 by 25 miles (37 by 40 km), of restricted airspace. The area is connected to the internal Nevada Test Site ";
        String str3 = str1;
        String str4 = str2;
        thread1 fthread = new thread1(str1);
        thread2 sthread = new thread2(str2);
        third_thread trd3 = new third_thread(str3);
        fourth_thread trd4 = new fourth_thread(str4);
        fthread.start();
        sthread.start();
        trd3.start();
        trd4.start();
        ...
        System.out.println("Time taken to count words with 4 threads = " + diff + "ms");

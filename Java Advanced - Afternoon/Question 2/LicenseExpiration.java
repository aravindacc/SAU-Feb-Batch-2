...
public class LicenseExpiration {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            StreamResult file = new StreamResult(new File("InValidLicenses.xml"));

            // write data
            transformer.transform(source, console);
            transformer.transform(source, file);

            System.out.println("Successfully Created Expired Licenses File as InValidLicenses.xml");

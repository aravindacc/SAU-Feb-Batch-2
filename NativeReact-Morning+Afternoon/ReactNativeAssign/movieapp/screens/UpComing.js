...
//                 <Text style={{fontSize:40}}>UpComing</Text>
//             </View>
//         )
//     }
// }
...
class UpComing extends Component {
  ...
  async getData() {
    const res = await fetch(
      'https://api.themoviedb.org/3/movie/upcoming?api_key=ed92469c644d7cb38f2454002993afc2&language=en-US&page=2',
    );
  ...
  render() {
    ...
    return (
      <View style={appStyle.body}>
        <Text style={appStyle.topview}> Up Coming Movies </Text>
